...
var btn_uploadPic = document.getElementById("btn_uploadPic");

if (btn_uploadPic) {
  btn_uploadPic.addEventListener("click", function () {
    document.getElementById("profilePic").click();
  });
}

var postPicLink = document.getElementById("postPicLink");

if (postPicLink) {
  postPicLink.addEventListener("click", function () {
...
function followFriend(followid, btn_follow) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/follow", {
    followedid: followid
...
var btn_follw = document.querySelectorAll(".btn-follow");

if (btn_follw) {
  btn_follw.forEach(function (btn_follow) {
    btn_follow.addEventListener("click", function () {
      var followid = JSON.parse(btn_follow.dataset.id);
      followFriend(followid, btn_follow);
    });
  });
}

var likeimg = document.querySelectorAll(".likeimg");

function likePost(postId, likedBy, indexx) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/like", {
    postId: postId,
    likedBy: likedBy
  }).then(function (result) {
    if (result.data.ans) {
...
if (likes) {
  likes.forEach(function (like) {
    like.addEventListener("click", function () {
      var postId = JSON.parse(like.dataset.postid);
      var likedBy = JSON.parse(like.dataset.likedby);
      var index = like.dataset.indexx;
      likePost(postId, likedBy, index);
    });
  });
}

var commentSection = document.querySelectorAll(".medium-modal");
var comments = document.querySelectorAll(".comment");

if (comments) {
  comments.forEach(function (comment) {
    var postindex = comment.dataset.indexx;
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkahoy"] = self["webpackChunkahoy"] || [];
